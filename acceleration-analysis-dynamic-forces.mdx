...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%', margin: '1.25rem 0' }}>
  <TailwindWrapper>
	![Four-bar acceleration polygon at 120 degrees, with the crank centripetal acceleration, the coupler normal and tangential components, and the follower acceleration](./images/l4-four-bar-accel-polygon.svg)
  </TailwindWrapper>
</div>
