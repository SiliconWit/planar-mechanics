...
**Design Goal:** Create a Geneva mechanism indexing system that operates at 300 RPM while maintaining ±0.1mm positioning accuracy and minimal vibration.

**Key Requirements:**
- **High-Speed Operation**: 300 RPM input speed (5 Hz indexing)
- **Precision Positioning**: ±0.1mm repeatability
...
<Tabs>
  ...
  <TabItem label="Geneva Wheel Analysis">
    ...
    **Peak Angular Acceleration:**
    - Occurs at φ = ±30° (during engagement/disengagement)
