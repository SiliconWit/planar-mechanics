...
This is the central worked example. We program a rise and draw its displacement, velocity, and acceleration to scale, the graphical heart of cam design. It follows the same [draw, solve, simulate](./position-analysis-planar-linkages#methods-of-kinematic-analysis) rhythm as the linkage lessons: draw the motion to scale, find its peaks analytically, then confirm in the simulator.
